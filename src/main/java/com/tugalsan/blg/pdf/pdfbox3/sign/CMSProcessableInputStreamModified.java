 ...
 */
public class CMSProcessableInputStreamModified implements CMSTypedData {

    private final InputStream in;
    private final ASN1ObjectIdentifier contentType;

    CMSProcessableInputStreamModified(InputStream is) {
        this(new ASN1ObjectIdentifier(CMSObjectIdentifiers.data.getId()), is);
    }

    CMSProcessableInputStreamModified(ASN1ObjectIdentifier type, InputStream is) {
        contentType = type;
        in = is;
    }
